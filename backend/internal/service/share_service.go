...
var (
	...
	ErrShareInvalidCharacterPersonaPackage  = errors.New("invalid character persona package")
	ErrShareCharacterPersonaPackageTooLarge = errors.New("character persona package exceeds 2MB")
...
type ShareCardDetail struct {
	...
	CharacterPersona *ShareCharacterPersonaView `json:"characterPersona,omitempty"`
