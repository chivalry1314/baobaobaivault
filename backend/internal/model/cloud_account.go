...
type CloudAccount struct {
	...
	UserID          string         `gorm:"type:uuid;not null;uniqueIndex:idx_cloud_account_owner,priority:1;index" json:"user_id"`
	Provider        string         `gorm:"type:varchar(32);not null;uniqueIndex:idx_cloud_account_owner,priority:2;index" json:"provider"`
