...
- [ ] `./scripts/init-production.sh` was run, or the templates were copied and renamed manually:
...
- [ ] `POSTGRES_PASSWORD` is a strong random secret (generated by the bootstrap script)
- [ ] `REDIS_PASSWORD` is a strong random secret (generated by the bootstrap script)
...
- [ ] `jwt.secret` is a strong random secret (generated by the bootstrap script)
- [ ] `security.field_encryption_key` is a strong 32-byte random key (base64 or raw string) used to encrypt storage credentials
