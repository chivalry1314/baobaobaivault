...
const { CardIcon, HomeIcon, KeyIcon, PlusIcon, ReviewIcon, SettingsIcon } = CreatorStudioIcons;
            ...
            <>
              ...
              <section className="dream-panel px-6 py-6 sm:px-8 sm:py-8">
                ...
                <div className="pt-6">
                  ...
                  {activeTab === "collections" ? <EmptyState title="收藏功能即将上线" description="你很快可以在这里管理收藏的卡片内容，先去首页浏览更多作品吧。" actionLabel="前往首页" actionHref="/" /> : null}
